...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > highcounty_count) and (countyvote_percentage > highcounty_percentage):
            highcounty_count = countyvotes
            highcounty_percentage = countyvote_percentage
